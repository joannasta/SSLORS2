...
# --- Directories ---
base = os.getcwd()
bathy_path = os.path.join(base, "src", "utils", "ocean_features", "bathy")
secchi_path = os.path.join(base, "src", "utils", "ocean_features", "secchi", "cmems_obs-oc_glo_bgc-transp_my_l4-gapfree-multi-4km_P1D_1747905614912.nc")
