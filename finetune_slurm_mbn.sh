...
#SBATCH --output=logs/finetune_slurm_agia_napa__ssl_ff_4.out  # Standard output log
#SBATCH --error=logs/finetune_slurm_agia_napa_ssl_ff_4.err   # Error log
...
SEED=42     
LOCATION="agia_napa"                              # Seed for reproducibility
