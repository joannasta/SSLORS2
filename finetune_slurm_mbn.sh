...
#SBATCH --output=logs/finetune_slurm_mbn_mocogeo_ocean_agia_napa.out  # Standard output log
#SBATCH --error=logs/finetune_slurm_mbn_mocogeo_ocean_agia_napa.err   # Error log
