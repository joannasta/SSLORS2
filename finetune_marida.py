...
def main():
    ...
    parser.add_argument("--model", type=str, default="moco", help="Model type")
    parser.add_argument("--epochs", type=int, default=100, help="Training epochs")
    parser.add_argument("--seed", type=int, default=42, help="Random seed")
    parser.add_argument("--weights", default="/home/jovyan/SSLORS/SSLORS2/results/trains/moco/version_38/checkpoints/epoch=31-step=53056.ckpt", help="Path to pretrained weights")
    parser.add_argument("--data_dir", default="/home/jovyan/SSLORS/marida", help="Path to data directory")
